...
export function JPEGCompressorClientPage() {
  ...
  const handleFilesSelected = (selectedFiles: File[]) => {
    ...
    const jpegFiles = selectedFiles.filter(
      (file) =>
    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="mb-8">
        <ToolProgressIndicator
          ...
          steps={[
            { label: "Upload", description: "Select JPEG files" },
      ...
      {currentStep === 1 && (
        <FileUploader onFilesSelected={handleFilesSelected} accept=".jpg,.jpeg" multiple={true} maxFiles={10} />
      )}
      ...
      {currentStep === 3 && (
        <div className="text-center p-12">
          ...
          <p>Compressing your JPEG files...</p>
        </div>
      )}
      ...
      <ToolSEOContent
        ...
        fileType="JPEG"
        benefits={[
          "Optimized for Web: Reduce file sizes for faster website loading times.",
          "Email Friendly: Compress images to fit email attachment size limits.",
          "Batch Processing: Compress multiple JPEG files at once to save time.",
        ]}
      />
    </div>
  )
